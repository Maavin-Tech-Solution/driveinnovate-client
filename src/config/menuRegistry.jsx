...
export const DEFAULT_MENU = {
  groups: [
    ...
    { label: 'Vehicles',  items: ['add-vehicle', 'rto-details', 'challans', 'vehicle-settings'] },
    { label: 'Analytics', items: ['alerts', 'reports'] },
    { label: 'Clients',   items: ['my-clients', 'add-client', 'teams'] },
    { label: 'More',      items: ['notifications', 'support', 'user-activity'] },
  ],
};
...
// The registry filtered to the pages this user is allowed to use.
export const allowedPages = (user) => MENU_REGISTRY.filter(p => canSeePage(p, user));
